...
import gank.presenter.GankPresenter;
import util.MediaLoader.FullActivity;
import gank.view.GankFragment;
import hundredSister.view.MediaFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    private void initFragment(){
        ...
        new GankPresenter(gankFragment);//在这里new一个Presenter 传入view引用
